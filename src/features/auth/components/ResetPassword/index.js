...
const ResetPasswordForm = ({ form, t, isLoading, emailCredentialExists, mobileCredentialExists, isResetMobile, onSubmit }) => (
      ...
      {({ hasErrors, handleSubmit }) => (
        <Form onSubmit={handleSubmit}>
          ...
          <FormItem
            ...
            rules={rules.passwordWithLimit}
            label={
              <Trans i18nKey="resetPassword.confirmNewPassword.label">Confirm new Password</Trans>
            }
          >
            <PasswordInput
              placeholder={t('resetPassword.confirmNewPassword.label', {
                defaultValue: 'Confirm New Password',
              })}
            />
          </FormItem>
          {!isResetMobile && !emailCredentialExists && (
            <FormItem
              id="email"
          ...
          {isResetMobile && !mobileCredentialExists && (
            <MobileNumberInput />
          )}
